...
from analytiikka_tie.analytiikka_tie_services_stack import AnalytiikkaTieServicesStack

"""
Pipeline stage

"""
class AnalytiikkaTieStage(Stage):
    ...
    def __init__(self,
        ...
        services_stack = AnalytiikkaTieServicesStack(self, 
