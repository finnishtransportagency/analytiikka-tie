...
from analytiikka_tie.analytiikka_tie_stage import AnalytiikkaTieStage


class AnalytiikkaTieStack(Stack):
    ...
    def __init__(self,
        ...
        # Kehitys stage
        dev_stage = pipeline.add_stage(AnalytiikkaTieStage(self,
                                                            f"{projectname}-dev",
                                                            "dev",
        ...
        # Tuotanto stage
        prod_stage = pipeline.add_stage(AnalytiikkaTieStage(self,
                                                             f"{projectname}-prod",
                                                             "prod",
